...
<body>
    ...
    <strong>Client adaugat cu succes!</strong><br>
	   <?php include 'connect_database.php';
			echo " <br>Nume: ".$_POST['nume']."<br>Prenume:".$_POST["prenume"]."<br>Telefon: ".$_POST['telefon']."<br>Adresa: ".$_POST['adresa'];
            $sql = "INSERT INTO clienti (nume, prenume, telefon, adresa) VALUES ('".$_POST["nume"]."','".$_POST["prenume"]."','".$_POST["telefon"]."','".$_POST["adresa"]."')";
